...
# The conn_max_age attribute is the lifetime of a database connection in seconds and 
# is available in Django 1.6+. If you do not set a value, it will default to 0 which 
# is Django's historical behavior of using a new database connection on each request. 
